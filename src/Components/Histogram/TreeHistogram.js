...
import { MarksHistogram } from  './HistogramMarks'
import { AxisBottom } from './AxisBottom'
import { AxisLeft } from './AxisLeft'
import { Dropdown } from './Dropdown'


import { scaleOrdinal, scaleSequential, schemeBlues, format, scaleLog, scaleLinear, scaleThreshold, scaleTime, max, timeFormat, extent, bin, timeMonths, sum, count } from 'd3'
...
export const TreeHistogram = ({ covidData, width, height }) => {
...
return(
  <>
    <rect width={width} heigh={height} fill='white' />
